...
import riva_asr_pb2 as riva__asr__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in riva_asr_pb2_grpc.py depends on'
...
class RivaSpeechRecognitionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Recognize = channel.unary_unary(
                ...
                request_serializer=riva__asr__pb2.RecognizeRequest.SerializeToString,
                response_deserializer=riva__asr__pb2.RecognizeResponse.FromString,
                _registered_method=True)
        self.StreamingRecognize = channel.stream_stream(
                '/nvidia.riva.asr.RivaSpeechRecognition/StreamingRecognize',
                request_serializer=riva__asr__pb2.StreamingRecognizeRequest.SerializeToString,
                response_deserializer=riva__asr__pb2.StreamingRecognizeResponse.FromString,
                _registered_method=True)
...
def add_RivaSpeechRecognitionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Recognize': grpc.unary_unary_rpc_method_handler(
                    servicer.Recognize,
                    request_deserializer=riva__asr__pb2.RecognizeRequest.FromString,
                    response_serializer=riva__asr__pb2.RecognizeResponse.SerializeToString,
            ),
            'StreamingRecognize': grpc.stream_stream_rpc_method_handler(
                    servicer.StreamingRecognize,
                    request_deserializer=riva__asr__pb2.StreamingRecognizeRequest.FromString,
                    response_serializer=riva__asr__pb2.StreamingRecognizeResponse.SerializeToString,
            ),
    }
...
class RivaSpeechRecognition(object):
    ...
    def Recognize(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/nvidia.riva.asr.RivaSpeechRecognition/Recognize',
            riva__asr__pb2.RecognizeRequest.SerializeToString,
            riva__asr__pb2.RecognizeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def StreamingRecognize(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/nvidia.riva.asr.RivaSpeechRecognition/StreamingRecognize',
            riva__asr__pb2.StreamingRecognizeRequest.SerializeToString,
            riva__asr__pb2.StreamingRecognizeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
